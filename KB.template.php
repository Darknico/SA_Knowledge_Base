...
function template_kb_addknow()
{
	...
	if ($modSettings['kb_enable_attachment'])
	{
		...
		echo '
					...
					<hr /><br />
					<div class="smalltext">
						<input type="file" size="60" name="attachment[]" id="attachment1" class="input_file" /> (<a href="javascript:void(0);" onclick="cleanFileInput(\'attachment1\');">', $txt['clean_attach'], '</a>)';// Show more boxes only if they aren\'t approaching their limit.
		if ($modSettings['kb_num_attachment'] > 1)
		{
			echo '
					...
					<div class="smalltext" id="moreAttachments">
